        ...
        {done ? (
          ...
          <>
            <div className="flex items-center justify-between">
              <h2 id="report-dialog-title" className="font-head text-lg font-bold text-brown">
                {t("title")}
              </h2>
              <button
                type="button"
            ...
            <p className="mt-1 text-sm text-brown-sec">{t("subtitle")}</p>
                ...
                >
                  ...
                  <span
                    className={`flex size-4 shrink-0 items-center justify-center rounded-full border-2 ${
                      reason === r ? "border-gold" : "border-border"
                    }`}
                  >
                    {reason === r && (
            ...
            <div className="mt-5 flex items-center justify-end gap-3">
              <button
                type="button"
                onClick={onClose}
                className="text-sm text-brown-sec hover:text-brown"
              >
                {t("cancel")}
              </button>
